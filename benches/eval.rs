...
fn factorial_tail(c: &mut Criterion) {
    ...
    c.bench_function("factorial_tail", |b| b.iter(|| machine.evaluate(term.clone())));
}
...
fn fibonacci_tail(c: &mut Criterion) {
    ...
    c.bench_function("fibonacci_tail", |b| b.iter(|| machine.evaluate(term.clone())));
}
...
fn complex_calling(c: &mut Criterion) {
    ...
    c.bench_function("complex_calling", |b| b.iter(|| machine.evaluate(term.clone())));
}
